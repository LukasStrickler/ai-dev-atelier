...
test_hook "curl --request\\ POST https://api.github.com/repos/owner/repo/releases" 2 "Blocks: curl escaped-space --request"
test_hook "curl --request POST https://api.github.com/repos/owner/repo/actions/workflows/release.yml/dispatches" 2 "Blocks: curl --request dispatch"
test_hook "curl --data-raw '{}' https://api.github.com/repos/owner/repo/releases" 2 "Blocks: curl --data-raw releases"
test_hook "curl --data-urlencode a=b https://api.github.com/repos/owner/repo/releases" 2 "Blocks: curl --data-urlencode releases"
test_hook "curl --data-ascii '{}' https://api.github.com/repos/owner/repo/releases" 2 "Blocks: curl --data-ascii releases"
test_hook "curl --data-binary @file https://api.github.com/repos/owner/repo/releases" 2 "Blocks: curl --data-binary releases"
test_hook "curl --json '{}' https://api.github.com/repos/owner/repo/releases" 2 "Blocks: curl --json releases"
test_hook "curl -d'{\"key\":\"value\"}' https://api.github.com/repos/owner/repo/releases" 2 "Blocks: curl -d immediate releases"
test_hook "curl -ddata https://api.github.com/repos/owner/repo/releases" 2 "Blocks: curl -ddata (no space)"
test_hook "curl -Tfile.txt https://api.github.com/repos/owner/repo/releases" 2 "Blocks: curl -T immediate releases"
test_hook "curl -Fkey=value https://api.github.com/repos/owner/repo/releases" 2 "Blocks: curl -F immediate releases"
test_hook "curl -X post https://api.github.com/repos/owner/repo/releases" 2 "Blocks: curl lowercase post"
...
test_hook "wget --post-file=/tmp/payload https://api.github.com/repos/owner/repo/releases" 2 "Blocks: wget post-file releases"
test_hook "wget --post-data='' https://api.github.com/repos/owner/repo/actions/workflows/release.yml/dispatches" 2 "Blocks: wget dispatch"
test_hook "wget --method=POST https://api.github.com/repos/owner/repo/releases" 2 "Blocks: wget --method=POST releases"
test_hook "http POST https://api.github.com/repos/owner/repo/releases" 2 "Blocks: httpie releases"
test_hook "http --form POST https://api.github.com/repos/owner/repo/releases" 2 "Blocks: httpie form releases"
test_hook "http --form https://api.github.com/repos/owner/repo/releases" 2 "Blocks: httpie --form releases"
test_hook "http -f https://api.github.com/repos/owner/repo/releases" 2 "Blocks: httpie -f releases"
test_hook "http --json https://api.github.com/repos/owner/repo/releases" 2 "Blocks: httpie --json releases"
test_hook "http -j https://api.github.com/repos/owner/repo/releases" 2 "Blocks: httpie -j releases"
test_hook "http --multipart https://api.github.com/repos/owner/repo/releases" 2 "Blocks: httpie --multipart releases"
test_hook "http post https://api.github.com/repos/owner/repo/releases" 2 "Blocks: httpie lowercase post releases"
test_hook "http https://api.github.com/repos/owner/repo/releases tag_name=v1.0.0" 2 "Blocks: httpie implicit post releases"
test_hook "http https://api.github.com/repos/owner/repo/releases tag_name=" 2 "Blocks: httpie implicit post empty value"
test_hook "http https://api.github.com/repos/owner/repo/releases tag_name@file.json" 2 "Blocks: httpie implicit post file upload"
test_hook "http https://api.github.com/repos/owner/repo/releases" 0 "Allows: httpie GET releases (no args)"
test_hook "http https://api.github.com/repos/owner/repo/releases Authorization:token" 0 "Allows: httpie GET releases with header"
test_hook "http https://api.github.com/repos/owner/repo/releases per_page==100" 0 "Allows: httpie GET releases with query param (==)"
test_hook "https POST api.github.com/repos/owner/repo/releases" 2 "Blocks: https releases"
test_hook "https post api.github.com/repos/owner/repo/releases" 2 "Blocks: https lowercase post releases"
test_hook "https POST https://api.github.com/repos/owner/repo/actions/workflows/release.yml/dispatches" 2 "Blocks: https dispatch"
...
test_hook "https api.github.com/repos/owner/repo/actions/workflows/release.yml/dispatches" 0 "Allows: https GET dispatches (no args)"
...
test_hook "curl https://api.github.com/repos/owner/repo/releases" 0 "Allows: curl GET releases (read-only)"
test_hook "wget https://api.github.com/repos/owner/repo/releases" 0 "Allows: wget GET releases (read-only)"
test_hook "curl https://api.github.com/repos/owner/repo/actions/workflows/release.yml/dispatches" 0 "Allows: curl GET dispatches (read-only)"
test_hook "wget https://api.github.com/repos/owner/repo/actions/workflows/release.yml/dispatches" 0 "Allows: wget GET dispatches (read-only)"
