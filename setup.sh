...
check_skills_dir() {
  ...
  local required_skills=("code-quality" "docs-check" "code-review" "pr-review")
...
main() {
  ...
  echo "     - Should list: code-quality, docs-check, docs-write, code-review, pr-review, search, research, agent-orchestration"
  echo ""
